  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold text-foreground">{t("branches.addBranch")}</h1>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg flex items-center gap-2">
            {t("branches.currencySettings")}
            <TooltipInfo content={t("tooltips.currency")} />
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
              ...
              <div className="space-y-3">
                {formData.additional_taxes.map((tax) => (
                  <div key={tax.id} className="flex items-center gap-3">
                    ...
                    <Button variant="ghost" size="icon" onClick={() => removeTax(tax.id)}>
