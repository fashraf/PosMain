...
import { ComboItemsList } from "@/components/items/ComboItemsList";
import { TooltipInfo } from "@/components/shared/TooltipInfo";
import { ArrowLeft, ArrowRight, Save, X, FileText, Tags, Clock, BarChart3, Package } from "lucide-react";
...
// Mock combo items (for demo purposes)
const MOCK_COMBO_ITEMS = [
  { name: "Margherita Pizza", quantity: 2 },
  { name: "Chicken BBQ", quantity: 4 },
  { name: "Soft Drink (Medium)", quantity: 2 },
];
    ...
    <div className="space-y-5 pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-4 space-y-5">
          ...
          {/* Combo Items Section - Only visible when is_combo is true */}
          {formData.is_combo && (
            <DashedSectionCard title={t("items.comboItems")} icon={Package} variant="amber">
              <ComboItemsList items={MOCK_COMBO_ITEMS} />
            </DashedSectionCard>
          )}
