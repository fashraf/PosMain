...
interface FinanceGradientBarChartProps {
...
export function FinanceGradientBarChart({ data, height = 300, title, layout = "vertical" }: FinanceGradientBarChartProps) {
  const gradId = "barGrad-premium";
      ...
      <div className="bg-card border border-border rounded-xl p-5">
        ...
        <ResponsiveContainer width="100%" height={height}>
          <BarChart data={data} layout="vertical" margin={{ top: 5, right: 30, bottom: 5, left: 80 }}>
            ...
            <Bar dataKey="value" radius={[0, 6, 6, 0]} fill={`url(#${gradId}-h)`}>
